...
describe('PizzasEffects', () => {
  ...
  describe('createPizza$', () => {
    it('should return created pizza from CreatePizzaSuccess', () => {
  ...
  describe('updatePizza$', () => {
    it('should return updated pizza from UpdatePizzaSuccess', () => {
  ...
  describe('removePizza$', () => {
    it('should return removed pizza from RemovePizzaSuccess', () => {
